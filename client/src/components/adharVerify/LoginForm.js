...
// import { Sprout, User, Phone, KeyRound, UserPlus, ArrowRight, Loader2 } from 'lucide-react';
...
//         setIsLoading(true);
//         try {
//             // const endpoint = 'http://localhost:6002/api/login';
//             const body = { mobileNumber, pin };

//             const { data } = await axios.post('http://localhost:6002/api/login', body);
...
//                         '• ಬಳಕೆದಾರ ಕಂಡುಬಂದಿಲ್ಲ. ದಯವಿಟ್ಟು ನೋಂದಣಿ ಮಾಡಿ.\n' +
//                         '• User not found. Please register.'
//                     );
//                 } else if (message === 'Invalid PIN') {
//                     toast.error(
//                         '• अमान्य पिन। कृपया पुनः प्रयास करें या पिन रीसेट करें।\n' +
//                         '• ಅಮಾನ್ಯ ಪಿನ್. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ ಅಥವಾ ಪಿನ್ ಮರುಹೊಂದಿಸಿ.\n' +
//                         '• Invalid PIN. Please try again or reset your PIN.'
//                     );
//                 } else {
//                     toast.error(
...
//             toast.success(
//                 '• पिन रीसेट सफल!\n' +
//                 '• ಪಿನ್ ಮರುಹೊಂದಿಸುವಿಕೆ ಯಶಸ್ವಿಯಾಗಿದೆ!\n' +
